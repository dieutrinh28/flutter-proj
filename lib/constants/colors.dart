...
class AppColors {
  ...
  static const Color baseDark = Color(0x00000000);
  ...
  static const Color orangeDark = Color(0xffE62E05);

  //
  static const Color brandPrimaryBase = Color(0xff2A9D8F);
  static const Color grayscaleText = Color(0xff333232);
  static const Color grayscaleAccent = Color(0xffB8B7B7);
  static const Color grayscaleBackground = Color(0xffF5F5F5);
}
